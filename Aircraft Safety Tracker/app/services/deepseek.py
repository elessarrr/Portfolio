...
class DeepSeekService:
    ...
    def generate_aircraft_summary(self, aircraft_data):
        ...
        prompt = (
            f"Provide a concise, factual summary of the safety record of the "
            f"{aircraft_data['manufacturer']} {aircraft_data['model_name']}, based STRICTLY on the Key Data "
            f"provided below.\n\n"
            f"Key Data:\n"
            ...
            f"Instructions:\n"
            f"1. Base your safety assessment PRIMARILY on the provided Key Data.\n"
            f"2. Do NOT cite external accident statistics, specific crash events, or data not reflected in these numbers.\n"
            f"3. Do NOT hallucinate or invent safety issues.\n"
            f"4. Use general knowledge ONLY for basic context (e.g., aircraft size, role, introduction era) to interpret the numbers.\n\n"
