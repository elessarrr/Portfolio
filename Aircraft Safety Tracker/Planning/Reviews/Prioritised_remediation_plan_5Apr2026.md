...
- [ ] P3 (Medium, 2–4 days): Coverage and engineering hygiene uplift
  - Steps: added deepseek/report_analyzer/faa_sdr tests and introduced pyproject-based ruff/mypy configuration baseline; pre-commit + full mypy cleanup still pending.
  - Success metric: module coverage targets ( deepseek >=80% , report_analyzer >=80% , faa_sdr_importer >0% ) reached; CI lint/type gates pending existing mypy debt remediation.
